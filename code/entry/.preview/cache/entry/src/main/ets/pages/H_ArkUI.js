...
class Film extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/H_ArkUI.ets(17:5)");
            Flex.height('100%');
            if (!isInitialRender) {
                Flex.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("pages/H_ArkUI.ets(20:7)");
            Swiper.loop(true);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("0");
            Text.debugLine("pages/H_ArkUI.ets(21:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("1");
            Text.debugLine("pages/H_ArkUI.ets(24:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("2");
            Text.debugLine("pages/H_ArkUI.ets(27:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("pages/H_ArkUI.ets(35:7)");
            Tabs.height(100);
            Tabs.flexGrow(1);
            if (!isInitialRender) {
                Tabs.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/H_ArkUI.ets(39:9)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("pages/H_ArkUI.ets(44:9)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
