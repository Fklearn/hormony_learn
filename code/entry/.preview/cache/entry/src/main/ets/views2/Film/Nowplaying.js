...
export default class Nowplaying extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.url = "http://192.168.10.101:3000";
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("views2/Film/Nowplaying.ets(23:5)");
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("views2/Film/Nowplaying.ets(24:7)");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.padding(20);
                        ListItem.debugLine("views2/Film/Nowplaying.ets(26:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
    ...
    FilmItem(item, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("views2/Film/Nowplaying.ets(47:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("views2/Film/Nowplaying.ets(48:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("views2/Film/Nowplaying.ets(51:7)");
