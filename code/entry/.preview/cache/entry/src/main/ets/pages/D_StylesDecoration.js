...
class D_StylesDecoration extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/D_StylesDecoration.ets(7:5)");
            Row.height('100%');
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/D_StylesDecoration.ets(8:7)");
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/D_StylesDecoration.ets(10:9)");
            //有参数
            Text.fontSize(50);
            //有参数
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            //无参数
            Divider.create();
            Divider.debugLine("pages/D_StylesDecoration.ets(14:9)");
            if (!isInitialRender) {
                //无参数
                Divider.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/D_StylesDecoration.ets(17:9)");
            Text.margin(50);
            Text.border({
                width: 5,
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/D_StylesDecoration.ets(24:9)");
            if (!isInitialRender) {
                Divider.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/D_StylesDecoration.ets(26:9)");
            //配置事件
            Button.onClick(() => {
...
function Hello(obj, parent = null) {
    (parent ? parent : this).observeComponentCreation((elmtId, isInitialRender) => {
        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
        Text.create(obj.msg);
        Text.debugLine("pages/D_StylesDecoration.ets(42:3)");
        Text.margin(50);
        Text.border({
            width: 5,
            color: { "id": 16777226, "type": 10001, params: [], "bundleName": "com.edu.myapplication", "moduleName": "entry" }
