export default class Nowplaying extends ViewPU {
    ...
    async getList() {
        this.list = [
            ...
            {
                title: "再见，李可乐",
                poster: { "id": 16777222, "type": 20000, params: [], "bundleName": "com.edu.myapplication", "moduleName": "entry" }
            },
            {
                title: "热搜",
                poster: { "id": 16777221, "type": 20000, params: [], "bundleName": "com.edu.myapplication", "moduleName": "entry" }
            }
        ];
    }
    async aboutToAppear() {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("views1/Film/Nowplaying.ets(27:5)");
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("views1/Film/Nowplaying.ets(28:7)");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.padding(20);
                        ListItem.debugLine("views1/Film/Nowplaying.ets(30:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
    ...
    FilmItem(item, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("views1/Film/Nowplaying.ets(51:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("views1/Film/Nowplaying.ets(52:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("views1/Film/Nowplaying.ets(55:7)");
