...
export default class Home extends ViewPU {
    ...
    NavigationMenus(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/Home.ets(24:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/Home.ets(26:7)");
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/Home.ets(50:5)");
            Row.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("微信");
            Text.debugLine("pages/Home.ets(51:7)");
            Text.width('100');
            if (!isInitialRender) {
                Text.pop();
            }
    ...
    MyMenu(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Menu.create();
            Menu.debugLine("pages/Home.ets(61:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            MenuItem.create({ startIcon: { "id": 16777224, "type": 20000, params: [], "bundleName": "com.example.wechatdemo", "moduleName": "entry" }, content: "菜单选项" });
            MenuItem.debugLine("pages/Home.ets(62:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            MenuItem.create({ startIcon: { "id": 16777224, "type": 20000, params: [], "bundleName": "com.example.wechatdemo", "moduleName": "entry" }, content: "菜单选项" });
            MenuItem.debugLine("pages/Home.ets(65:7)");
            if (!isInitialRender) {
                MenuItem.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Home.ets(77:5)");
            Column.width('100%');
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Navigation.create();
            Navigation.debugLine("pages/Home.ets(78:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("pages/Home.ets(80:9)");
            if (!isInitialRender) {
                Stack.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Home.ets(82:11)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("pages/Home.ets(83:13)");
            TextInput.width('92%');
            TextInput.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/Home.ets(91:13)");
        ...
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/Home.ets(93:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/Home.ets(100:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/Home.ets(107:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Home.ets(122:11)");
            Flex.width('100%');
            Flex.height(200);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Home.ets(123:13)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Path.create();
            Path.debugLine("pages/Home.ets(124:15)");
            Path.width(20);
            Path.height(20);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/Home.ets(134:15)");
            List.margin(0);
            List.borderRadius(5);
        ...
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Home.ets(135:17)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Home.ets(138:17)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Home.ets(141:17)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Home.ets(144:17)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
...
class MenuRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Home.ets(194:5)");
            Flex.height(45);
            if (!isInitialRender) {
                Flex.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/Home.ets(195:7)");
            Image.width(21);
            Image.height(21);
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Home.ets(199:7)");
...
class MessageRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Flex.create({ direction: FlexDirection.Row, alignItems: ItemAlign.Center });
            Flex.debugLine("pages/Home.ets(217:5)");
            Flex.height(80);
            if (!isInitialRender) {
                Flex.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create(this.imagePath);
            Image.debugLine("pages/Home.ets(218:7)");
            Image.width(60);
            Image.height(60);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Home.ets(222:7)");
            Flex.height(55);
            Flex.margin({ left: 10 });
            if (!isInitialRender) {
                Flex.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("pages/Home.ets(223:9)");
            if (!isInitialRender) {
                Flex.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Home.ets(224:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Home.ets(228:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Home.ets(232:9)");
