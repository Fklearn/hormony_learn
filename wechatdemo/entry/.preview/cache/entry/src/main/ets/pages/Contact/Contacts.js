...
export default class Contacts extends ViewPU {
    ...
    NavigationMenus(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/Contact/Contacts.ets(16:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/Contact/Contacts.ets(18:7)");
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/Contact/Contacts.ets(28:5)");
            Row.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("通讯录");
            Text.debugLine("pages/Contact/Contacts.ets(29:7)");
            Text.width('100');
            if (!isInitialRender) {
                Text.pop();
            }
    ...
    itemHead(text, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(text);
            Text.debugLine("pages/Contact/Contacts.ets(37:5)");
            Text.fontSize(14);
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Contact/Contacts.ets(45:5)");
            Column.width('100%');
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Navigation.create();
            Navigation.debugLine("pages/Contact/Contacts.ets(46:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("pages/Contact/Contacts.ets(48:9)");
            Stack.width('100%');
            Stack.height('100%');
            if (!isInitialRender) {
                Stack.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            //
            Column.create();
            Column.debugLine("pages/Contact/Contacts.ets(50:11)");
            if (!isInitialRender) {
                //
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("pages/Contact/Contacts.ets(51:13)");
            TextInput.width('92%');
            TextInput.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/Contact/Contacts.ets(59:13)");
        ...
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/Contact/Contacts.ets(61:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact/Contacts.ets(66:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact/Contacts.ets(71:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact/Contacts.ets(77:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact/Contacts.ets(83:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact/Contacts.ets(88:15)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index) => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    ListItemGroup.debugLine("pages/Contact/Contacts.ets(94:17)");
                    ...
                    const forEachItemGenFunction = (_item, i) => {
                        const p = _item;
                        {
                            ...
                            const itemCreation = (elmtId, isInitialRender) => {
                                ...
                                ListItem.debugLine("pages/Contact/Contacts.ets(97:21)");
                                if (!isInitialRender) {
                                    ListItem.pop();
                                }
                                ViewStackProcessor.StopGetAccessRecording();
                            ...
                            const observedDeepRender = () => {
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Flex.debugLine("pages/Contact/Contacts.ets(98:23)");
                                    Flex.height(55);
                                    if (!isInitialRender) {
                                        Flex.pop();
                                    }
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("pages/Contact/Contacts.ets(99:25)");
                                    Image.width(45);
                                    Image.height(45);
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Text.create(p['name']);
                                    Text.debugLine("pages/Contact/Contacts.ets(103:25)");
                                    Text.fontSize(18);
                                    Text.margin({ left: 10 });
                                    if (!isInitialRender) {
                                        Text.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            AlphabetIndexer.debugLine("pages/Contact/Contacts.ets(136:9)");
...
class ContactsRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Flex.create({ direction: FlexDirection.Row, alignItems: ItemAlign.Center });
            Flex.debugLine("pages/Contact/Contacts.ets(189:5)");
            Flex.height(55);
            if (!isInitialRender) {
                Flex.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/Contact/Contacts.ets(190:7)");
            Image.width(41);
            Image.height(41);
            if (!isInitialRender) {
                Image.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Contact/Contacts.ets(193:7)");
            Text.fontSize(18);
            Text.margin({ left: 10 });
            if (!isInitialRender) {
                Text.pop();
