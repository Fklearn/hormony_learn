    ...
    initialRender() {
        ...
        });
        {
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create({ "id": 16777236, "type": 20000, params: [], "bundleName": "com.example.wechatdemo", "moduleName": "entry" });
                    Image.width(20);
                    Image.height(20);
                    if (!isInitialRender) {
                        Image.pop();
        ...
        });
        {
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create({ "id": 16777243, "type": 20000, params: [], "bundleName": "com.example.wechatdemo", "moduleName": "entry" });
                    Image.width(25);
                    Image.height(25);
                    if (!isInitialRender) {
                        Image.pop();
        ...
        }
        {
            ...
            const observedDeepRender = () => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create({ "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.wechatdemo", "moduleName": "entry" });
                    Image.width(25);
                    Image.height(25);
                    if (!isInitialRender) {
                        Image.pop();
