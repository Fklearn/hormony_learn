...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/Index.ets(41:5)");
            Column.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Index.ets(42:7)");
            Text.fontSize(20);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/Index.ets(45:7)");
            Divider.height(2);
            Divider.width('100%');
            if (!isInitialRender) {
                Divider.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(51:7)");
            //  动态变动的字，使用的是 `
            //  宽高占比、颜色等使用'
            Button.fontSize(20);
            //  动态变动的字，使用的是 `
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(60:7)");
            Button.margin(10);
            Button.fontSize(30);
            Button.backgroundColor('#36D');
            Button.fontColor(Color.White);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Index.ets(69:7)");
            Button.margin(10);
            Button.fontSize(30);
            Button.backgroundColor('#36D');
            Button.fontColor(Color.White);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Button.createWithLabel('网络请求测试-Base64解析');
            Button.debugLine("pages/Index.ets(103:7)");
            Button.margin(10);
            Button.fontSize(30);
            Button.backgroundColor('#36D');
            Button.fontColor(Color.White);
