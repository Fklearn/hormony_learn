...
class Secend extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/Secend.ets(18:5)");
            Row.height('100%');
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Secend.ets(19:7)");
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Secend.ets(20:9)");
            Text.width('100%');
            Text.fontSize(15);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/Secend.ets(27:9)");
            // Text()
            //   .fontSize(50)
            //   .fontWeight(FontWeight.Bold)
            Text.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Secend.ets(32:9)");
            Button.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Secend.ets(44:9)");
            Button.margin(10);
            Button.fontColor(Color.Blue);
            Button.fontSize(30);
            Button.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Secend.ets(58:9)");
            Button.margin(10);
            Button.fontColor(Color.Blue);
            Button.fontSize(30);
            Button.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/Secend.ets(71:9)");
            Button.margin(10);
            Button.fontColor(Color.Blue);
            Button.fontSize(30);
            Button.width('100%');
